...
#[cfg(all(not(wasm_browser), any(feature = "aws-lc-rs", feature = "ring", feature = "rustls-pure")))]
...
impl Endpoint {
    ...
    #[cfg(all(not(wasm_browser), any(feature = "aws-lc-rs", feature = "ring", feature = "rustls-pure")))] // `EndpointConfig::default()` is only available with these
