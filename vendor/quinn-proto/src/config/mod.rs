...
#[cfg(any(feature = "rustls-aws-lc-rs", feature = "rustls-ring", feature = "rustls-pure"))]
...
#[cfg(any(feature = "aws-lc-rs", feature = "ring", feature = "rustls-pure"))]
impl Default for EndpointConfig {
    fn default() -> Self {
        ...
        {
            use aws_lc_rs::hmac;
            return Self::new(Arc::new(hmac::Key::new(hmac::HMAC_SHA256, &reset_key)));
        }
        #[cfg(feature = "ring")]
        {
            use ring::hmac;
        ...
        #[cfg(all(feature = "rustls-pure", not(feature = "ring"), not(feature = "aws-lc-rs")))]
        {
            return Self::new(Arc::new(crate::crypto::pure_like::PureHmacKey::new(&reset_key)));
        }
        #[allow(unreachable_code)]
        {
            unreachable!("no crypto backend for EndpointConfig")
        }
    }
}
...
impl ServerConfig {
    ...
    pub fn with_crypto(crypto: Arc<dyn crypto::ServerConfig>) -> Self {
        ...
        #[cfg(all(feature = "aws-lc-rs", not(feature = "ring")))]
        {
            ...
            return Self::new(crypto, Arc::new(master_key));
        }
        #[cfg(feature = "ring")]
        {
            use ring::hkdf;
        ...
        #[cfg(all(feature = "rustls-pure", not(feature = "ring"), not(feature = "aws-lc-rs")))]
        {
            return Self::new(
                crypto,
                Arc::new(crate::crypto::pure_like::PureHandshakeTokenKey::from_secret(
                    &master_key,
                )),
            );
        }
        #[allow(unreachable_code)]
        {
            unreachable!("no crypto backend for ServerConfig::with_crypto")
        }
    }
}
